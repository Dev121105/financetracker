      ...
      >
        ...
        >
          <Select className="select-input-2">
            <Select.Option value="Tiffin">Tiffin</Select.Option>
            <Select.Option value="salary">Salary</Select.Option>
            <Select.Option value="dailywage">Daily Wage</Select.Option>
            <Select.Option value="investment">Investment</Select.Option>
            <Select.Option value="miscellenous">Miscellenous</Select.Option>
            <Select.Option value="online">Online Mode</Select.Option>
            {/* Add more tags here */}
          </Select>
        </Form.Item>
        <Form.Item>
